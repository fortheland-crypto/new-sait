...
const SITE_CONFIG = {
  ...
  COMPANY_SUBTITLE: "Видеонаблюдение • Спутниковое ТВ: Установка под ключ",
  ...
  INSTALLATION_PRICES: {
    CAMERA_SINGLE: 11000,    // Монтаж видеонаблюдения дома и офиса (от 11 000 ₸)
    ...
    TV_BRACKET: 5000,        // Навес телевизора и монтаж кронштейна (от 5 000 ₸)
